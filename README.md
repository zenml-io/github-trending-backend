...
The repository is a hard fork of the awesome [stackcli repo by hedyhli](https://github.com/hedyhli/starcli/). All credit goes to 
hedyhli for the amazing work done to query the data.
